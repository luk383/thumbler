...
const _mockLessons = [
  Lesson(
    ...
    options: ['100 milliseconds', '13 milliseconds', '500 milliseconds'],
  ...
  Lesson(
    ...
    options: ['Hive mind', 'Emergent intelligence', 'Distributed computing'],
    correctAnswer: 'Emergent intelligence',
  ),
  Lesson(
    id: '3',
    category: '📚 History',
    ...
    correctAnswer: 'To keep gambling',
  ),
  Lesson(
    id: '4',
    category: '💡 Technology',
    ...
    options: ['Password', 'Domain name', 'Page content'],
  ...
  Lesson(
    ...
    options: ['Refraction', 'Rayleigh scattering', 'Absorption'],
  ...
  Lesson(
    ...
    correctAnswer: 'The value of the best alternative forgone',
  ),
  Lesson(
    id: '8',
    category: '🎨 Art & Nature',
  ...
  Lesson(
    ...
    correctAnswer: 'Physics equations break down',
  ),
  Lesson(
    id: '10',
    category: '🧪 Chemistry',
    ...
    correctAnswer: 'It disrupts ice crystal formation',
  ),
  Lesson(
    id: '11',
    category: '🧲 Physics',
    ...
    correctAnswer: 'Moving electric charges',
  ),
  Lesson(
    id: '12',
    category: '🗣️ Language',
