...
class DailyQuestNotifier extends Notifier<DailyQuestState> {
  ...
  DailyQuestState _loadState(String today) {
    ...
    final questType = QuestType.values[typeIndex.clamp(0, QuestType.values.length - 1)];
    ...
    final completed =
        _box.get(_completedKey, defaultValue: false) as bool;
  ...
  // Called by QuizSection when a correct answer is selected.
